...
## Stop project (Wake up we are in Libya)
Finally!, the new administration stopped the postal addressing project before starting the implementation of the second phase.
